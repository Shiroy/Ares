...
void PlayerCommands::handleInput(const sf::Keyboard::Key &key, const bool &isPressed) {
  switch (key) {
    case sf::Keyboard::Z:movingUp = isPressed;
      break;
    case sf::Keyboard::S:movingDown = isPressed;
      break;
    case sf::Keyboard::Q:movingLeft = isPressed;
      break;
    case sf::Keyboard::D:movingRight = isPressed;
      break;
    case sf::Keyboard::F1:if (isPressed) quadTreeDebug = !quadTreeDebug;
  }
}
